...
passa direto....
Essa primeira tela e um servidor node. um exemplo sendo redirecionado para outra porta e sendo acesso pela web, dica o ngrok e registrado, mais...
...
![Sistema_Tela ngrok](docs/ngrok2.gift)
